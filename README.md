...
| onClone                    | Function          |                                                                                                            | Function involved in cloning DOM node which is being dragged. `function({clonedNode})`. Must return the same or modified `clonedNode`. Used when cloned DOM node needs to be modified before appending to HTML body tag                                                                                                                                                                                                                                                |
